...
subtraction = "this is the romval of a quantity from a number"
multiplication = "this is the increase of a number by a specific amount"
division = "this is the reducion of a number by a specified amount"
...
op3 = "You have selected DIVISION, "
  document.getElmentbyId("maths").innerHTML = op3 + division
}

else
if (operator == "") {
op4 = "You have selected nothing, try again"
  document.getElmentbyId("maths").innerHTML = op4
}
